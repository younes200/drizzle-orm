...
var EffectSQLiteNodeSession = class extends __sqlite_core_effect_session_ts.SQLiteEffectSession {
	static [__entity_ts.entityKind] = "EffectSQLiteNodeSession";
...
var EffectSQLiteNodeTransaction = class extends __sqlite_core_effect_session_ts.SQLiteEffectTransaction {
	static [__entity_ts.entityKind] = "EffectSQLiteNodeTransaction";
	transaction(transaction) {
...
//#endregion
exports.EffectSQLiteNodeSession = EffectSQLiteNodeSession;
exports.EffectSQLiteNodeTransaction = EffectSQLiteNodeTransaction;
