...
let _effect_sql_sqlite_do_SqliteClient = require("@effect/sql-sqlite-do/SqliteClient");

//#region src/effect-sqlite-do/driver.ts
var EffectSQLiteDoDatabase = class extends __sqlite_core_effect_db_ts.SQLiteEffectDatabase {
	static [__entity_ts.entityKind] = "EffectSQLiteDoDatabase";
};
/**
...
* ```
*/
const make = effect_Effect.fn("SQLiteDODrizzle.make")(function* (config) {
	const client = yield* _effect_sql_sqlite_do_SqliteClient.SqliteClient;
	...
	const db = new EffectSQLiteDoDatabase(dialect, new require_effect_sqlite_do_session.EffectSQLiteDOSession(client, dialect, relations, {
		logger,
		cache,
...
exports.EffectSQLiteDoDatabase = EffectSQLiteDoDatabase;
exports.make = make;
