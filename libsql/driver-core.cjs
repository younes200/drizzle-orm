...
var LibSQLDatabase = class extends __sqlite_core_async_db_ts.SQLiteAsyncDatabase {
...
function construct(client, config = {}) {
	...
	const db = new LibSQLDatabase("async", dialect, new require_libsql_session.LibSQLSession(client, dialect, relations, {
		logger,
		cache: config.cache
	}, void 0), relations);
	db.$client = client;
