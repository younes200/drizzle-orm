...
function drizzle(...params) {
	...
	return require_libsql_driver_core.construct(typeof connection === "string" ? (0, _libsql_client_web.createClient)({ url: connection }) : (0, _libsql_client_web.createClient)(connection), DrizzleSQLiteConfig);
}
(function(_drizzle) {
