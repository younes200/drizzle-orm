...
var LibSQLSession = class LibSQLSession extends __sqlite_core_async_session_ts.SQLiteAsyncSession {
...
var LibSQLTransaction = class LibSQLTransaction extends __sqlite_core_async_session_ts.SQLiteAsyncTransaction {
