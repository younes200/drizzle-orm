...
var EffectSQLiteBunSession = class extends __sqlite_core_effect_session_ts.SQLiteEffectSession {
	static [__entity_ts.entityKind] = "EffectSQLiteBunSession";
...
var EffectSQLiteBunTransaction = class extends __sqlite_core_effect_session_ts.SQLiteEffectTransaction {
	static [__entity_ts.entityKind] = "EffectSQLiteBunTransaction";
	transaction(transaction) {
...
//#endregion
exports.EffectSQLiteBunSession = EffectSQLiteBunSession;
exports.EffectSQLiteBunTransaction = EffectSQLiteBunTransaction;
