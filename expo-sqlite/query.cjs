...
let __sqlite_core_async_query_ts = require("../sqlite-core/async/query.cjs");
let __sqlite_core_index_ts = require("../sqlite-core/index.cjs");

//#region src/expo-sqlite/query.ts
const useLiveQuery = (query, deps = []) => {
	const [data, setData] = (0, react.useState)((0, __entity_ts.is)(query, __sqlite_core_async_query_ts.SQLiteAsyncRelationalQuery) && query.mode === "first" ? void 0 : []);
	const [error, setError] = (0, react.useState)();
	const [updatedAt, setUpdatedAt] = (0, react.useState)();
	(0, react.useEffect)(() => {
		const entity = (0, __entity_ts.is)(query, __sqlite_core_async_query_ts.SQLiteAsyncRelationalQuery) ? query.table : query.config.table;
