...
//#region src/tursodatabase-sync/session.ts
var TursoDatabaseSyncSession = class TursoDatabaseSyncSession extends __sqlite_core_async_session_ts.SQLiteAsyncSession {
	static [__entity_ts.entityKind] = "TursoDatabaseSyncSession";
	logger;
	cache;
...
var TursoDatabaseSyncTransaction = class TursoDatabaseSyncTransaction extends __sqlite_core_async_session_ts.SQLiteAsyncTransaction {
	static [__entity_ts.entityKind] = "TursoDatabaseSyncTransaction";
...
//#endregion
exports.TursoDatabaseSyncSession = TursoDatabaseSyncSession;
exports.TursoDatabaseSyncTransaction = TursoDatabaseSyncTransaction;
