...
var EffectSQLiteWasmSession = class extends __sqlite_core_effect_session_ts.SQLiteEffectSession {
	static [__entity_ts.entityKind] = "EffectSQLiteWasmSession";
...
var EffectSQLiteWasmTransaction = class extends __sqlite_core_effect_session_ts.SQLiteEffectTransaction {
	static [__entity_ts.entityKind] = "EffectSQLiteWasmTransaction";
	transaction(transaction) {
...
//#endregion
exports.EffectSQLiteWasmSession = EffectSQLiteWasmSession;
exports.EffectSQLiteWasmTransaction = EffectSQLiteWasmTransaction;
