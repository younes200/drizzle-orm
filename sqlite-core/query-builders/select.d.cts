...
import { AnySQLiteSelectQueryBuilder, GetSQLiteSetOperators, SQLiteCreateSetOperatorFn, SQLiteSelectConfig, SQLiteSelectCrossJoinFn, SQLiteSelectDynamic, SQLiteSelectHKTBase, SQLiteSelectJoinFn, SQLiteSelectKind, SQLiteSelectQueryBuilderHKT, SQLiteSelectWithout, SQLiteSetOperatorExcludedMethods, SQLiteSetOperatorWithResult, SelectedFields, SetOperatorRightSelect } from "./select.types.cjs";
...
interface SQLiteSelectBuilderConstructor {
  new (config: {
...
declare class SQLiteSelectBuilder<TSelection extends SelectedFields | undefined, TRunResult, THKT extends SQLiteSelectHKTBase = SQLiteSelectQueryBuilderHKT> {
  private builder;
...
//#endregion
export { SQLiteSelectBase, SQLiteSelectBuilder, SQLiteSelectBuilderConstructor, except, intersect, union, unionAll };
