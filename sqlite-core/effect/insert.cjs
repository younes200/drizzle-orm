...
var SQLiteEffectInsertBase = class extends __sqlite_core_query_builders_insert_ts.SQLiteInsertBase {
	static [__entity_ts.entityKind] = "SQLiteEffectInsert";
	/** @internal */
...
(0, __effect_core_query_effect_ts.applyEffectWrapper)(SQLiteEffectInsertBase);

//#endregion
exports.SQLiteEffectInsertBase = SQLiteEffectInsertBase;
