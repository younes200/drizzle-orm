...
declare function mapRelationalRow(rows: Record<string, unknown> | Record<string, unknown>[], isOne: boolean, buildQueryResultSelection: BuildRelationalQueryResult['selection'], /** Needed for SQLite as it returns JSON values as strings */
...
declare function mapRelationalRowFromArrays(rows: unknown[][] | unknown[], isOne: boolean, buildQueryResultSelection: BuildRelationalQueryResult['selection'], /** Needed for SQLite as it returns JSON values as strings */
...
type RelationalRowsMapperGenerator<T = any> = (config: RelationalQueryMapperConfig) => RelationalRowsMapper<T>;
declare function makeDefaultRqbMapper<T = any>({
  ...
  rootJsonMappers,
  arrayModeRoot
}: RelationalQueryMapperConfig): RelationalRowsMapper<T>;
