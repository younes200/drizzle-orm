...
//#region src/mssql-core/subquery.d.ts
type SubqueryWithSelection<TSelection extends ColumnsSelection, TAlias extends string> = Subquery<TAlias, AddAliasToSelection<TSelection, TAlias, 'mssql'>> & AddAliasToSelection<TSelection, TAlias, 'mssql'>;
type WithSubqueryWithSelection<TSelection extends ColumnsSelection, TAlias extends string> = WithSubquery<TAlias, AddAliasToSelection<TSelection, TAlias, 'mssql'>> & AddAliasToSelection<TSelection, TAlias, 'mssql'>;
