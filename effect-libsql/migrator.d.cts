...
import { EffectLibsqlDatabase } from "./driver.cjs";
...
declare function migrate<TRelations extends AnyRelations>(db: EffectLibsqlDatabase<TRelations>, config: MigrationConfig): effect_Effect0.Effect<undefined, EffectDrizzleQueryError | MigratorInitError | effect_unstable_sql_SqlError0.SqlError, never>;
//#endregion
export { migrate };
