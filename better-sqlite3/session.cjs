...
var BetterSQLiteSession = class extends __sqlite_core_async_session_ts.SQLiteAsyncSession {
...
var BetterSQLiteTransaction = class BetterSQLiteTransaction extends __sqlite_core_async_session_ts.SQLiteAsyncTransaction {
